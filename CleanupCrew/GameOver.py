...
class GameOver(Scene):
    ...
    def __init__(self, director):
        ...
        self.gameOverFont = pygame.font.Font('Assets/ARCADECLASSIC.TTF', 120)
        self.gameOverText = self.gameOverFont.render('GAME   OVER', True, (48, 255, 185))
    ...
    def on_draw(self, screen):
        ...
        screen.blit(self.gameOverText, (1280 // 2 - 300, 720 // 2 - 150))
